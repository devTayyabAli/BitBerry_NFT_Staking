...
import metamask from '../Accets/metamask.svg'
import wallet_connect from '../Accets/wallet_connect.svg'
      ...
      <Modal.Body>
        ...
        >
          <div
            ...
            onClick={()=>{dispatch(connectWalletAction(2),props.setShoww(false))}}
          >
            <img
              _ngcontent-vsv-c60=""
              src={metamask}
          ...
          <div
            ...
            onClick={()=>{dispatch(connectWalletAction(1),props.setShoww(false))}}
          >
            <img
              _ngcontent-vsv-c60=""
              src={wallet_connect}
